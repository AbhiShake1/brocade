...
const ShopByCategoryItem = () => {
    return (
        <div className='w-[272px] h-[372px] relative'>
            ...
            <div
                className='absolute w-full py-2.5 bottom-0 text-white text-center bg-gradient-to-t from-neutral-400 to-transparent pl-8 pb-8 flex flex-row items-end'>
                <div className='flex flex-row justify-start'>
                    <div>
                        ...
                        <div className='h-4'/>
                        <div
                            className="px-2 py-[16.50px] bg-zinc-800 rounded-sm justify-start items-start gap-2.5 inline-flex">
